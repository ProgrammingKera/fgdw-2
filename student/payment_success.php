...
// Get payment details
$stmt = $conn->prepare("
    SELECT p.*, f.amount as fine_amount, f.reason, b.book_name, b.author, u.name as user_name, u.email
    FROM payments p
...
<div class="container">
    <div class="success-container">
        ...
        <h1 class="success-book_name">Payment Successful!</h1>
                ...
                <div class="receipt-section">
                    ...
                    <div class="detail-grid">
                        <div class="detail-item">
                            ...
                            <span class="value"><?php echo htmlspecialchars($payment['book_name']); ?></span>
                        </div>
                        <div class="detail-item">
