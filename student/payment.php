...
if (isset($_GET['fine_id'])) {
    ...
    $stmt = $conn->prepare("
        SELECT f.*, b.book_name, b.author, ib.return_date, ib.actual_return_date
        FROM fines f
...
<div class="container">
    <div class="payment-header">
        ...
        <h1 class="page-book_name">
            <i class="fas fa-credit-card"></i> Secure Payment Gateway
        </h1>
        <p class="payment-subbook_name">Complete your fine payment securely with Stripe</p>
    </div>
            ...
            <div class="payment-summary-card">
                ...
                <div class="summary-body">
                    <div class="fine-details">
                        <div class="book-info">
                            <h4><?php echo htmlspecialchars($fine['book_name']); ?></h4>
            ...
            <div class="stripe-payment-card">
                <div class="payment-form-header">
                    ...
                    <div class="accepted-cards">
                        <i class="fab fa-cc-visa" book_name="Visa"></i>
                        <i class="fab fa-cc-mastercard" book_name="Mastercard"></i>
                        <i class="fab fa-cc-amex" book_name="American Express"></i>
                        <i class="fab fa-cc-discover" book_name="Discover"></i>
                    </div>
                </div>
