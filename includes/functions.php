...
function sendNotification($conn, $userId, $message) {
    $stmt = $conn->prepare("INSERT INTO notifications (user_id, message) VALUES (?, ?)");//ahan ek SQL query prepare ki gayi hai jo notifications table me naya record insert karegi.? placeholders hain (parameters baad me bind kiye jaayenge).
